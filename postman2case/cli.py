...
def main():
    parser = argparse.ArgumentParser(
        description="Convert postman testcases to YAML/JSON testcases for HttpRunner.")
    ...
    if not output_testset_file:
        harfile = os.path.splitext(postman_testset_file)[0]
        output_testset_file = "{}.{}.{}".format(harfile, "output", output_file_type.lower())
    else:
